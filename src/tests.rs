...
mod test {
    ...
    fn sha3_224_test() {
        ...
        let result = keccak(text, SHA3::SHA3_224).unwrap();
    ...
    fn sha3_256_test() {
        ...
        let result = keccak(text, SHA3::SHA3_256).unwrap();
        assert_eq!(precompiled_sha3_output, encode(result));
    }
    ...
    fn sha3_384_test() {
        ...
        let result = keccak(text, SHA3::SHA3_384).unwrap();
        assert_eq!(precompiled_sha3_output, encode(result));
    }
    ...
    fn keccak_224_test() {
        ...
        let result = keccak(text, SHA3::KECCAK_224).unwrap();
    ...
    fn keccak_256_test() {
        ...
        let result = keccak(text, SHA3::KECCAK_256).unwrap();
        assert_eq!(precompiled_keccak_output, encode(result));
    }
    ...
    fn keccak_384_test() {
        ...
        let result = keccak(text, SHA3::KECCAK_384).unwrap();
        assert_eq!(precompiled_keccak_output, encode(result));
    }
    ...
    fn keccak_512_test() {
        ...
        let result = keccak(text, SHA3::KECCAK_512).unwrap();
        assert_eq!(precompiled_keccak_output, encode(result));
    }
}